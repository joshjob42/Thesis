...
\begin{subfigure}
  \centering
  \includegraphics[width=.8\linewidth]{chapters/Higgs/noisy_couplers_h}
\end{subfigure}%
\begin{subfigure}
  \centering
  \includegraphics[width=.8\linewidth]{chapters/Higgs/noisy_couplers_J}
\end{subfigure}
...
\begin{figure}[h]
\centering
\begin{subfigure}\centering\includegraphics[width=\textwidth]{chapters/Higgs/SAvc_shifted_vc_70--60_GS}\end{subfigure}
\hfill
\vspace{-5cm}
\begin{subfigure}\centering\includegraphics[width=\textwidth]{chapters/Higgs/SAvc_shifted_vc_70--80_GS}\end{subfigure}
\hfill
\vspace{-5cm}
\begin{subfigure}\centering\includegraphics[width=\textwidth]{chapters/Higgs/SAvc_shifted_vc_70--60_L5}\end{subfigure}
\hfill
\vspace{-5cm}
\begin{subfigure}\centering\includegraphics[width=\textwidth]{chapters/Higgs/SAvc_shifted_vc_70--80_L5}\end{subfigure}
\vspace{-4cm}
